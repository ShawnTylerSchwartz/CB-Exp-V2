...
for i=1:totalTrials
    ...
    if trialCond(i)==0 %image
        ...
        if trialCondTrace(i)==1 % from mid to target
            [mouseX,mouseY]= MouseTrace(w,mSize,x,y,[xmPt ymPt],[xtPt ytPt]);
        else
            [mouseX,mouseY]= MouseTrace(w,mSize,x,y,[xmPt ymPt],[xtPtO ytPtO]);
        end
